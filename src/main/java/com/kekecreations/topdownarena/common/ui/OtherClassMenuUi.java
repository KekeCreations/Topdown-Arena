...
public class OtherClassMenuUi extends InteractiveCustomUIPage<MenuWithButtonsData> {
    ...
    public OtherClassMenuUi(@Nonnull PlayerRef playerRef, OtherPlayerRoundComponent roundData, @Nonnull CustomPageLifetime lifetime) {
